#!/usr/bin/env python3
"""
featuresyrup: catalyst-specific features built on graphpancake

Usage:
    featuresyrup <command> [options]
...
Examples:
    ...
    # Create database
    featuresyrup create-db molecules.db
    ...
    featuresyrup filter by-criteria \
        --database molecules.db \
        --where "num_atoms > 18"
    ...
    featuresyrup stats molecules.db --detailed
...
Alternative Usage (if entry point not available):
    python -m featuresyrup.cli <command> [options]
"""
...
class FeaturesyrupCLI:
    """Main CLI handler for featuresyrup operations."""
    ...
    def create_database(self, args):
        ...
        try:
            MolecularGraph.create_database(str(db_path))
    ...
    def load_data(self, args):
        ...
        try:
            ...
            qm_data = generate_qm_data_dict(
                ...
                cationic_output=args.cationic_output,
                anionic_output=args.anionic_output,
                neutral_nbo=args.neutral_nbo,
                cationic_nbo=args.cationic_nbo,
        ...
        try:
            ...
            for _, row in molecules.iterrows():
                ...
                try:
                    ...
                    targets = mol_graph.get_target_features()
...
def main():
    ...
    parser = argparse.ArgumentParser(
        prog='featuresyrup',
        description='featuresyrup v. 1.0',
    ...
    load_parser.add_argument('--neutral-output', required=True, type=str, help='Neutral ORCA output file')
    load_parser.add_argument('--cationic-output', required=True, type=str, help='Cationic ORCA output file')
    load_parser.add_argument('--anionic-output', required=True, type=str, help='Anionic ORCA output file')
    ...
    query_parser.add_argument('--graph-type', type=str, choices=['catalyst'],
    ...
    export_parser.add_argument('--graph-type', type=str, choices=['catalyst'],
                             help='Filter by graph type')
